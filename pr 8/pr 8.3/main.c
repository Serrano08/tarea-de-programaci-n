...
void main(void)
{
    ...
    scanf("%S", &e3.nombre);
    fflush("Ingrese el departamento de la empresa: ");
    ...
    printf("%s\t%s\t%.2f\t%s\t%d\t%d\t%s",e1>Sueldo, e1->nombre, e1->departamento, e1->direccion.calle, e1->direccion.numero, e1->direccion.cp, e1->direccion.localidad);
